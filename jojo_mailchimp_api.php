...
{
    function subscribe($email, $list_id=false)
    {
    	...
    	return $api->listSubscribe($list_id, $email, NULL, 'html', false); //args = ($id, $email_address, $merge_vars=NULL, $email_type='html', $double_optin=true, $update_existing=false, $replace_interests=true, $send_welcome=false)
    }
